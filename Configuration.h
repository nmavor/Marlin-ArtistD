...
#define STRING_CONFIG_H_AUTHOR "(nmavor)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "SPIDER"
...
#define HOTEND_OFFSET_Y { 0.0, 0.5 }  // (mm) relative Y-offset for each nozzle
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #define PID_PARAMS_PER_HOTEND // Uses separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  25.61,  26.69 }
    #define DEFAULT_Ki_LIST {   2.19,   2.17 }
    #define DEFAULT_Kd_LIST {  74.79,  81.93 }
  #else
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 409 , 409 }
